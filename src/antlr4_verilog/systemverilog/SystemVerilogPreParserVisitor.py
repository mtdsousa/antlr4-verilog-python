...
class SystemVerilogPreParserVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by SystemVerilogPreParser#text_macro_identifier.
    def visitText_macro_identifier(self, ctx:SystemVerilogPreParser.Text_macro_identifierContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by SystemVerilogPreParser#ifdef_group_of_lines.
    def visitIfdef_group_of_lines(self, ctx:SystemVerilogPreParser.Ifdef_group_of_linesContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by SystemVerilogPreParser#ifndef_group_of_lines.
    def visitIfndef_group_of_lines(self, ctx:SystemVerilogPreParser.Ifndef_group_of_linesContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by SystemVerilogPreParser#elsif_group_of_lines.
    def visitElsif_group_of_lines(self, ctx:SystemVerilogPreParser.Elsif_group_of_linesContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by SystemVerilogPreParser#else_group_of_lines.
    def visitElse_group_of_lines(self, ctx:SystemVerilogPreParser.Else_group_of_linesContext):
        return self.visitChildren(ctx)
