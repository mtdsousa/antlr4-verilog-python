...
public interface VerilogParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link VerilogParser#genvar_primary}.
	 * @param ctx the parse tree
	 */
	void enterGenvar_primary(VerilogParser.Genvar_primaryContext ctx);
	/**
	 * Exit a parse tree produced by {@link VerilogParser#genvar_primary}.
	 * @param ctx the parse tree
	 */
	void exitGenvar_primary(VerilogParser.Genvar_primaryContext ctx);
	/**
